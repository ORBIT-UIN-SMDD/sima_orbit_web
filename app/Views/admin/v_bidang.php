        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#backDropModal">
                    <span class="tf-icons bx bx-book-add"></span>&nbsp; Tambah Bidang
                </button>
                <!-- FOR MODALS -->
                    ...
                    <div class="modal-dialog">
                        <form class="modal-content" action="/user/newUser" method="post">
                            <div class="modal-header">
                                <h5 class="modal-title" id="backDropModalTitle">Tambah Bidang</h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="First group">
                                        ...
                                        <a type="button" href="/admin/delete/<?= $item["bidang_id"] ?>" class="btn btn-outline-secondary">
