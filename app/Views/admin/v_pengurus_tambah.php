...
<form action="/pengurus/save" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="col-md-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= (\Config\Services::validation()->hasError('nama')) ? 'is-invalid' : ''  ?> " id="nama" name="nama" placeholder="nama" value="<?= old('nama'); ?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="basic-default-company">NIM</label>
                        <input type="text" class="form-control <?= ($validation->hasError('nim')) ? 'is-invalid' : ''  ?>" id="nim" name="nim" placeholder="Nomor Induk Mahasiswa" value="<?= old('nim'); ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="basic-default-phone">Fakultas</label>
                        <select class="form-select" id="fakultas_id" name="fakultas_id" aria-label="Default select example">
                            <option selected="">Pilih Jenis Fakultas</option>
                            <?php foreach ($fakultas as $item) : ?>
                                <option value="<?= $item["fakultas_id"] ?>"><?= $item["fakultas_nama"] ?></option>
                            <?php endforeach ?>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="basic-default-phone">Program Studi</label>
                        <select class="form-select" id="prodi_id" name="prodi_id" aria-label="Default select example">
                            <option selected="">Pilih Jenis Program Studi</option>
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="basic-default-phone">Bidang</label>
                        <select class="form-select" id="bidang_id" name="bidang_id" aria-label="Default select example">
                            <option selected="">Pilih Jenis Bidang</option>
