...
<div class="col-md-12 mb-4">
    <div class="card ">
        ...
        <div class="card-body">
            <h5 class="card-title text-center">Pendataaan Pengurus UKM ORBIT UIN Sjech M.djamil Djambek Bukittingi periode 2023</h5>
            <!-- <div class="container">
...
<form action="/pendataan/pengurusPost" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="col-md-8">
            <div class="card mb-4">
